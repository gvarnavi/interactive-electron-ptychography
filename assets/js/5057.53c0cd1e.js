...
const newlines = new dist.ExternalTokenizer((input, stack) => {
  let prev;
  if (input.next < 0) {
...
const indentation = new dist.ExternalTokenizer((input, stack) => {
...
const trackIndent = new dist.ContextTracker({
  start: topIndent,
  reduce(context, term) {
...
const legacyPrint = new dist.ExternalTokenizer(input => {
  for (let i = 0; i < 5; i++) {
...
const pythonHighlighting = (0,highlight_dist.styleTags)({
  "async \"*\" \"**\" FormatConversion FormatSpec": highlight_dist.tags.modifier,
  "for while if elif else try except finally return raise break continue with pass assert await yield match case": highlight_dist.tags.controlKeyword,
  "in not and or is del": highlight_dist.tags.operatorKeyword,
  "from def class global nonlocal lambda": highlight_dist.tags.definitionKeyword,
  import: highlight_dist.tags.moduleKeyword,
  "with as print": highlight_dist.tags.keyword,
  Boolean: highlight_dist.tags.bool,
  None: highlight_dist.tags.null,
  VariableName: highlight_dist.tags.variableName,
  "CallExpression/VariableName": highlight_dist.tags.function(highlight_dist.tags.variableName),
  "FunctionDefinition/VariableName": highlight_dist.tags.function(highlight_dist.tags.definition(highlight_dist.tags.variableName)),
  "ClassDefinition/VariableName": highlight_dist.tags.definition(highlight_dist.tags.className),
  ...
  Comment: highlight_dist.tags.lineComment,
  Number: highlight_dist.tags.number,
  String: highlight_dist.tags.string,
  FormatString: highlight_dist.tags.special(highlight_dist.tags.string),
  ...
  Ellipsis: highlight_dist.tags.punctuation,
  At: highlight_dist.tags.meta,
...
;// CONCATENATED MODULE: ./node_modules/@datalayer/jupyter-react/node_modules/@jupyterlab/codemirror/node_modules/@codemirror/lang-python/dist/index.js
...
const snippets = [
    /*@__PURE__*/(0,autocomplete_dist.snippetCompletion)("def ${name}(${params}):\n\t${}", {
        label: "def",
        detail: "function",
        type: "keyword"
    }),
    /*@__PURE__*/(0,autocomplete_dist.snippetCompletion)("for ${name} in ${collection}:\n\t${}", {
        label: "for",
        detail: "loop",
        type: "keyword"
    }),
    ...
    /*@__PURE__*/(0,autocomplete_dist.snippetCompletion)("import ${module}", {
        label: "import",
        detail: "statement",
        type: "keyword"
    }),
    /*@__PURE__*/(0,autocomplete_dist.snippetCompletion)("from ${module} import ${names}", {
        label: "from",
        detail: "import",
        type: "keyword"
    })
...
*/
const globalCompletion = /*@__PURE__*/(0,autocomplete_dist.ifNotIn)(dontComplete, /*@__PURE__*/(0,autocomplete_dist.completeFromList)(/*@__PURE__*/globals.concat(snippets)));
...
*/
const pythonLanguage = /*@__PURE__*/language_dist.LRLanguage.define({
    name: "python",
    parser: /*@__PURE__*/parser.configure({
        props: [
            /*@__PURE__*/language_dist.indentNodeProp.add({
                ...
                "TupleExpression ComprehensionExpression ParamList ArgList ParenthesizedExpression": /*@__PURE__*/(0,language_dist.delimitedIndent)({ closing: ")" }),
                "DictionaryExpression DictionaryComprehensionExpression SetExpression SetComprehensionExpression": /*@__PURE__*/(0,language_dist.delimitedIndent)({ closing: "}" }),
                "ArrayExpression ArrayComprehensionExpression": /*@__PURE__*/(0,language_dist.delimitedIndent)({ closing: "]" }),
            ...
            /*@__PURE__*/language_dist.foldNodeProp.add({
                "ArrayExpression DictionaryExpression SetExpression TupleExpression": language_dist.foldInside,
...
*/
function python() {
    return new language_dist.LanguageSupport(pythonLanguage, [
