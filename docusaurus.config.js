...
const config = {
    title: 'Interactive Electron Ptychography',  // set this
    tagline: '',
    favicon: 'img/favicon.ico',

    // The url for your site: <url>/<baseUrl>/
    url: 'https://gvarnavi.github.io',  // set this
    baseUrl: '/interactive-electron-ptychography/',  // set this
    ...
    customFields: {
      ...
      bitly: "bit.ly/interactive-ptycho", //set this
    },

    // (optional) GitHub pages deployment config.
    organizationName: 'gvarnavi',  // set this – GitHub Org or Username
    projectName: 'interactive-electron-ptychography',  // set this – repo name
    trailingSlash: false,
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ({
            ...
            navbar: {
                title: 'Interactive Electron Ptychography | bit.ly/interactive-ptycho',  // set this
                logo: {
                    alt: 'Slides',
                    src: 'img/favicon.svg',
                },
